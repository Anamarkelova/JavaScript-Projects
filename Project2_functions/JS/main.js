...
// Create a function that displays a greeting when the button is clicked. 
function My_First_Function() { 
    var greeting = "Hello!"; 
    var name = "Ana"; 
    // Display the greeting inside the paragraph. 
document.getElementById("message").innerHTML = greeting + " " + name; 
}